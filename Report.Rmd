...
url_train <- "https://www.unsw.adfa.edu.au/unsw-canberra-cyber/cybersecurity/ADFA-NB15-Datasets/a%20part%20of%20training%20and%20testing%20set/UNSW_NB15_training-set.csv"
train_file <- "dataset/UNSW_NB15_training-set.csv"
f <- download.file(url_train,train_file)
url_test <- "https://www.unsw.adfa.edu.au/unsw-canberra-cyber/cybersecurity/ADFA-NB15-Datasets/a%20part%20of%20training%20and%20testing%20set/UNSW_NB15_testing-set.csv"
test_file <- "dataset/UNSW_NB15_testing-set.csv"
f <- download.file(url_train,train_file)
source("R/code.R")
data_train = loadCSVDataSet(train_file)
data_test <- loadCSVDataSet(test_file)
```
